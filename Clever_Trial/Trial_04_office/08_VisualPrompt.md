```json
{
  "VisualPrompt": {
    "CRITICAL": {
      ...
      "text": "On-image ad copy required: bold modern sans-serif headline '告別3點3罪惡感！' in the upper sky-blue background zone, above and behind the OL, clear of the product cluster; subtitle '日本製 · 清蛋白' smaller directly below. Both must be legible at mobile screen size."
    },
    "HIGH": {
