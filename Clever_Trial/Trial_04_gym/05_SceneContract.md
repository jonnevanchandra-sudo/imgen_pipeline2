```json
{
  "SceneContract": {
    "Metadata": {
      ...
      "variant": "Trial_04_gym — bright yoga/fitness studio, on-image ad typography required",
      ...
      "generation_mode": "Partial Generation — brand assets (pack, shaker, logo) reproduced from references; human subject, environment, and typography overlay fully generated"
    },
    ...
    "Entities": [
      {
        "id": "entity_01",
        "description": "Hong Kong OL, naturally healthy and attractive, approximately 25–32 years old, East Asian, in stylish active wear: white mesh/crochet crop top and pastel lemon-yellow workout shorts. Post-workout cool-down — calm, lightly flushed, quietly satisfied. Seated on the edge of a rolled yoga mat or standing with relaxed posture, holding the clear protein shaker or setting it down. Fully generated persona.",
      ...
      {
        "id": "entity_03",
        "description": "Transparent shaker bottle with pale-yellow, clear (non-milky) protein drink inside, lemon slice visible. CLEVER logo on the bottle body. Held by entity_01 or placed on the gym floor beside her.",
        "roles": ["Brand-Bearing", "Product"],
        "source": "Reference Asset",
        "asset_id": "asset_01",
        "prompt_reference_id": "reference_asset_01"
    ...
    "RelativeScale": [
      ...
      { "entity_id": "entity_05", "reference_entity": "entity_01", "scale_relationship": "Gym floor — only the near, clean section of floor immediately around the OL visible in frame." },
    ...
    "GenerationRequirements": {
      ...
      "required_supporting_objects": [
        "Rolled yoga mat on the floor to one side of the OL — the only prop beyond the pack and shaker"
      ],
    ...
    "PreservationContracts": [
      {
        ...
        "immutable_attributes": [
          "Young East Asian adult woman, naturally healthy and attractive — not hyper-muscular, not gym archetype",
          "Stylish active wear: white mesh/crochet crop top + pastel/lemon-yellow workout shorts",
          "Calm, lightly flushed, post-workout satisfied expression and relaxed body language",
          "Post-workout cool-down posture — not mid-exercise, not straining"
        ],
        "flexible_attributes": [
          "Exact facial identity (fully generated persona)",
          "Specific hairstyle details",
          "Exact pose — holding shaker or setting it down, seated on mat edge or standing",
          "Exact shorts shade within pastel/lemon-yellow range"
        ]
      },
      {
        "entity_id": "entity_02",
      ...
      },
      {
        ...
        "immutable_attributes": [
          ...
          "Positioned in upper window-light background zone, not overlapping OL or product cluster",
