```json
{
  "CompositionRenderingContract": {
    "Metadata": {
      ...
      "variant": "Trial_06_gym_male — bright window-lit studio, male model from image7.png + image (1).png, on-image ad typography"
    },
    ...
    "HierarchyPlan": [
      ...
      },
      {
        ...
        "reason": "The male model's calm, post-workout expression and lean athletic build are the emotional proof of the recovery ritual — read after the hero product cluster, never outshining it. His face, reproduced from reference_asset_03 and reference_asset_04, must be clearly recognizable.",
        "source": "Narrative"
      },
      {
        "element": "entity_07",
        "hierarchy_level": "Secondary",
        "luminance_priority": "Mid",
        "reason": "On-image ad headline ('日日飲，激發體能' + '日本製·清蛋白') is a campaign-mandatory element — white text in the bright window-light background zone is legible but does not compete with the hero product cluster. It occupies the background breathing room above and behind the model.",
        "source": "Campaign"
      },
      {
        "element": "entity_04",
      ...
      },
      {
        ...
        "reason": "The clean studio floor and rolled mat anchor the scene moment; must read as a fitness context but never compete with the hero cluster.",
      ...
      },
      {
        ...
        "reason": "The large studio windows are bright but their light is softened by depth-of-field into a smooth, glowing sky-blue plane — they frame the subject and carry the typography without creating competing focal points.",
        "source": "Environmental"
      }
    ],
    ...
    "VisualFlowPlan": {
      ...
      "reason": "Gentle spiral from the foreground hero product cluster up to the male model's face and relaxed posture, then outward to the ad headline in the upper window-light background zone. The bright, near-empty studio space gives breathing room so the spiral feels natural and unhurried."
    },
    ...
    "CameraPlan": {
      ...
      "source": "Hierarchy",
      "reason": "85mm at f/4 gives flattering compression and keeps the male model and product proportionally natural. Atmospheric DoF softens the studio windows in the background into a smooth, glowing sky-blue plane while keeping the typography legible. Commercial Isolation (f/1.8–f/2.8) unnecessary and would risk blurring the headline."
    },
    ...
    "LightingPlan": {
      ...
      "possible_techniques": [
        "natural_daylight_key_from_studio_windows",
    ...
    "MaterialPlan": {
      ...
      "possible_techniques": [
        ...
        "natural_studio_floor_texture"
      ],
      "human_skin_rendering": "Natural skin texture visible — pores, fine lines, subtle tone variation and a slight healthy flush from post-workout warmth. No airbrushing, no beauty filter, no plastic or wax sheen. Reproduce the male model's natural skin register from reference_asset_03 and reference_asset_04.",
      "reason": "Liquid clarity is the most important material truth. Light condensation on the shaker reinforces 'cold and refreshing after a warm session.' Matte pack surface vs. glossy shaker body creates material contrast. The lightweight athletic t-shirt fabric adds tactile authenticity to the sportswear read without the visual weight of heavy gym gear."
    },
    ...
    "AtmosphericPlan": {
      ...
      "reason": "Bright, open, airy atmosphere carries the 'post-workout release and lightness' emotion. The large studio windows make the background feel like the space is breathing — light and open. The typography reads as floating cleanly in that light. The overall atmosphere should evoke: 'this is the best moment of the session.'"
    },
    ...
    "RenderingConstraints": {
      ...
      "face_reference_note": "The male model's face must be reproduced from reference_asset_03 (image7.png) and reference_asset_04 (image (1).png) — both show the same person and should be treated as cross-validating identity sources — with natural skin texture intact and no beauty filter.",
      "typography_legibility_note": "On-image headline '日日飲，激發體能' and subtitle '日本製·清蛋白' must be fully legible at mobile screen size. White text must maintain sufficient contrast against the bright studio window-light background."
    },

    "PerceptualValidation": {
      "SkinNaturalismAssertion": "Rendered skin must show visible pores, fine lines, and subtle tone variation with a light healthy flush from post-workout warmth — no smoothing, no beauty filter. Face must remain recognizable as the reference shown in image7.png and image (1).png.",
      "DepthOfFieldRealismAssertion": "Bokeh must follow progressive depth-dependent falloff from 85mm f/4 — no flat cutout blur. The studio window background must soften to a smooth luminous plane.",
      "TypographyLegibilityAssertion": "Ad headline '日日飲，激發體能' must be readable as text at mobile screen size — white text against the bright studio window-light background must maintain clear contrast. Not distorted, not partially obscured by the male model or product, not washed out by the window brightness."
    }
  }
}
```
