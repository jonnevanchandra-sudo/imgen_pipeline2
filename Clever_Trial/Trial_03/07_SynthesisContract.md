```json
{
  "SynthesisContract": {
    ...
    "ExecutiveSummary": "A Hong Kong office lady's 3:30pm break, reframed from guilty snacking into a light, guilt-free 'light-beauty' ritual. She sits at a near-empty, clean desk — photoshoot-set quality, nothing on the surface except the CLEVER lemon CLEAR PROTEIN pouch, its transparent clear-drink shaker, and one small clock at ~3:30. Calm, lightly satisfied, quietly confident. The clear drink and pack are the brightest, sharpest heroes; she is the emotional proof; the clean minimal background is the intentional frame. Brand assets (lemon pack, clear shaker, CLEVER logo) are reproduced from image1.png and image4.png — not invented. The clean, near-empty background is a deliberate scene construction decision, not a default.",
    ...
    "CommunicationResolution": {
      "PrimaryCommunication": {
        ...
        "derived_from": {
          ...
          "art_direction": "Office Light-Beauty Ritual; clear drink as hero on clean minimal desk; Low structural density; quiet confidence."
        }
      },
      ...
      "SuppressedCommunication": [
        ...
        { "statement": "Windows, plants, busy office furniture visible in background.", "reason": "Scene Contract entity_06: background must be clean, minimal, near-empty — no competing background detail." }
      ],
      "MemoryAnchor": {
        "statement": "A clear lemon protein drink on a clean, minimal desk at 3:30 — refreshing, light, and guilt-free.",
        "justification": "The combination of a genuinely clear drink AND a near-empty, pristine desk surface is what makes this image distinctive and memorable. Neither element alone is enough; together they create an instantly legible visual statement about what CLEVER stands for."
      }
    },
    ...
    "ObservableSignalMapping": [
      ...
      },
      {
        ...
        "Visual Evidence Examples": ["Photoshoot-set quality desk", "Clean sky-blue or white background plane"],
        "allocation_priority": "MustSurvive"
      },
      {
    ...
    "CommunicationAllocation": [
      ...
      { "component": "Clean, near-empty minimal desk and background", "priority": "Critical", "survival_policy": "MustSurvive", "derived_from": ["AD: Low StructuralDensity", "AD: Clean Desk Sanctuary", "SceneContract entity_05/06"], "justification": "Low density is the mechanism that makes the hero legible; clutter destroys the concept." },
    ...
    "ExecutionResolution": {
      "PrimaryExecutionMode": "Single-moment lifestyle realism — a 3:30pm office break, hero is the clear lemon drink on a near-empty, minimal desk.",
      "SupportingExecutionModes": [
        ...
        "Photoshoot-set clean background (minimal, empty, sky-blue — a design choice, not a default)"
      ],
      "ExecutionRequirements": [
        "Drink must read as clear and translucent",
        "Desk surface must be near-empty — pack, shaker, and one small clock only",
        "Background must be clean, uncluttered, and minimal — no windows, plants, or office furniture",
    ...
    "RenderingResolution": {
      ...
      "PerceptualRendering": {
        ...
        "Atmosphere": "Bright, airy, high-key Japanese-refreshment mood. A near-empty, purposefully minimal personal space — the cleanliness itself is an emotion."
      },

      "PhysicalRendering": {
        "RealityModel": "Realistic",
        "CameraIntent": "Eye-level near medium shot at desk distance, peer-level — viewer feels seated across from her. 85mm perspective is slightly compressed and flattering; clean background reads as an intentional studio-quality choice at this focal length.",
        "CameraSpecs": {
          "focal_length_mm": "85mm",
          "aperture_f_stop": "f/4"
        },
        "LightingIntent": "Soft, bright high-key daylight. Clear drink and pack get the cleanest, most direct light with a gentle specular glint on glass and liquid. OL is lit a touch softer. Background is evenly lit so it reads as a smooth, shadow-free sky-blue plane — no practical light sources or window highlights behind the subject; nothing in the background outshines the hero product cluster.",
        "LuminanceHierarchy": [
        ...
        "OpticalIntent": "Progressive, depth-dependent bokeh from 85mm at f/4: foreground pack and shaker are crisp, OL is sharp to gently diffuse by depth, the already-minimal background softens further into a smooth even sky-blue plane. No flat uniform blur; no ring bokeh from busy backgrounds (background is already clean)."
      },

      "RenderingQuality": {
        "DetailRendering": "Highest detail on hero cluster (pack typography, logo, liquid clarity); progressively reduced toward background.",
        "TextureRendering": "Real skin texture, fabric weave, condensation, matte/gloss contrast on product materials.",
        "LightingRendering": "Clean high-key with controlled gentle speculars on glass; no harsh shadows; background lit flat and even.",
        "DepthRendering": "Clear foreground/midground separation; the already-minimal background reads as a single smooth plane at the background depth.",
        "CommercialRendering": "Polished, clean, social-commerce quality — lifestyle authenticity, not a sterile packshot; not a busy editorial either."
      },
      ...
      "AuthenticityBehavior": {
        ...
        "EnvironmentalAuthenticityRendering": "The desk is intentionally minimal and clean — like a curated photoshoot set, not a real cluttered workspace. The cleanliness IS the authenticity here: it signals intention, not neglect. Only natural imperfections in the desk surface material itself (slight reflection, subtle grain) are acceptable — no props, clutter, or everyday objects.",
        ...
        "ImperfectionRendering": "Credibility over perfection for skin and material behavior — no plastic or AI-smooth rendering. The desk and background, however, should be genuinely clean and pristine — surface imperfections in those elements work against the intended aesthetic."
      }
    },

    "PreservationResolution": {
      "PreservedEntities": [
        "entity_02 — CLEVER lemon CLEAR PROTEIN pouch (Near Exact, reproduce from reference_asset_01 / image1.png; product only, no gym background)",
        ...
        "entity_04 — CLEVER logo / wordmark + Made-in-Japan cue (Exact, reproduce from reference_asset_02 / image4.png; no timing-clock or pricing)"
      ],
      "PreservedContext": [
        "Near-empty, minimal, clean desk — only pack, shaker, and small clock visible",
        "Clean, uncluttered sky-blue background — no windows, plants, furniture, or competing visual information",
        "Single HK OL subject, office-appropriate, calm and quietly confident"
      ],
      "PreservedBrandRequirements": [
        "CLEVER brand name / logo clearly present",
        "Made in Japan / 日本製 cue legible",
        "Sky-blue and white brand color system",
        "Product reads as clear, light, and refreshing — never heavy or opaque"
      ],
      "PreservedNarrativeRequirements": [
        "Quiet, guilt-free, light-beauty confidence — no sacrifice, no diet anxiety",
        "Everyday achievable office break moment, not a dramatic transformation"
      ],
      "PreservedConstraints": [
        "No medical or curative claims",
        "No hardcore gym or supplement positioning",
        "No legible invented marketing slogans generated by the image model",
        "No background clutter — the clean minimal desk and background are non-negotiable scene constraints"
      ]
    }
  }
}
