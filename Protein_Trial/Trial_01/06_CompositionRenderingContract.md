# Composition & Rendering Contract — Natural Protein Powder (Stage 6.1)
...
```json
{
  "CompositionRenderingContract": {
    ...
    "HierarchyPlan": [
      {
        ...
        "reason": "The unguarded savoring moment is the entire communication (Narrative: skepticism → genuine enjoyment); it must read first.",
        "source": "Narrative"
      },
      {
        "element": "entity_02",
        "hierarchy_level": "Secondary",
        "reason": "The drink is the object of the pleasure and the appetite carrier — second read, tightly coupled to the face.",
        "source": "Narrative"
      },
      {
        "element": "entity_04",
        "hierarchy_level": "Secondary",
        "reason": "Ingredients are the visible proof of 'natural' — they must be identifiable without competing with the human moment.",
        "source": "Preservation"
      },
      {
        "element": "entity_03",
        "hierarchy_level": "Secondary",
        "reason": "The pack anchors the ad to the product but is held to kitchen-object status (Strategy: no SupplementHero).",
        "source": "Preservation"
      },
      {
        "element": "entity_05",
        "hierarchy_level": "Supporting",
        "reason": "Kitchen establishes 'ordinary life, not a regime' but stays atmospheric.",
    ...
    "LightingPlan": {
      ...
      "reason": "Soft directional morning window light keys the face and the glass, with gentle natural falloff into the kitchen — warmth and ordinariness without theatrical shaping. Appetite appeal depends on daylight credibility."
    },
    ...
    "OpticalPlan": {
      ...
      "bokeh_behavior": "Progressive falloff for 50mm at f/2.2: face and glass on the focal plane; counter ingredients and pack ~0.5m forward/below remain semi-legible and identifiable; window and kitchen background dissolve into soft, bright bokeh. No flat uniform blur.",
      "reason": "Depth guides the eye down the attention path while keeping the ingredient evidence readable — if the ingredients blur to abstraction, the 'natural' message dies."
    },
...
- **DOF realism:** bokeh tied to 50mm / f/2.2 with a named falloff curve; ingredient legibility is explicitly protected because it carries the rank-2 message.
...
- **Boundary:** no messaging, narrative, or scene-construction changes — SceneContract treated as source truth.
